...
if os.name == "nt":
    ...
    lib = CDLL("/home/iomz/darknet/libdarknet.so", RTLD_GLOBAL)
...
def main(argv):
    ...
    thresh = 0.25
    configPath = "yolov3-artefact.cfg"
    weightPath = "backup/yolov3-artefact_final.weights"
    metaPath = "artefact-data/obj.data"
    svoPath = None
